...
<head>
    ...
    <title>Page5(tulip and Daisy)</title>
    <style>
        body {
...
<!-- القائمة الجانبية للمستخدم -->
    ...
    <h1 class="product-title">tulip and Daisy</h1>
    <div class="product-container">
        <img  id="mainProductImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYbnitEg9Dw3HJPKvYNDtG42MuFZ31kH-5JVrN3chi1VXZ-PwlJKaXFl6DjX2kHhnOevY&usqp=CAU" 
        ...
        <div class="product-thumbnails">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYbnitEg9Dw3HJPKvYNDtG42MuFZ31kH-5JVrN3chi1VXZ-PwlJKaXFl6DjX2kHhnOevY&usqp=CAU" 
                alt="صورة مصغرة 1" class="thumbnail"
				onclick="changeMainImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYbnitEg9Dw3HJPKvYNDtG42MuFZ31kH-5JVrN3chi1VXZ-PwlJKaXFl6DjX2kHhnOevY&usqp=CAU')">
            <img src="https://tse4.mm.bing.net/th?id=OIP.GO57t5p8PPv1Mo4xrH_RkgHaHS&pid=ImgDet&w=158&h=155&c=7" 
                alt="صورة مصغرة 2" class="thumbnail"
				onclick="changeMainImage('https://tse4.mm.bing.net/th?id=OIP.GO57t5p8PPv1Mo4xrH_RkgHaHS&pid=ImgDet&w=158&h=155&c=7')">
            <img src="https://tse4.mm.bing.net/th?id=OIP.Rus21nEmIcUb38GNDMbS2AHaNK&pid=ImgDet&w=158&h=279&c=7" 
                alt="صورة مصغرة 3" class="thumbnail"
				onclick="changeMainImage('https://tse4.mm.bing.net/th?id=OIP.Rus21nEmIcUb38GNDMbS2AHaNK&pid=ImgDet&w=158&h=279&c=7')">
        </div>
        <div class="price">$20.00 JOD</div>
    </div>

    <form action="page5php.php" method="post">
   <input type="hidden" name="bouquet_id" value="2222">
   <input type="hidden" name="Boiqiets_Name" value="tulip and Daisy">
 ...
 <script>
	 ...
	 <p style="font-size: 30px;"> <strong style="color: #FF69B4;"> DESCRIPTION</strong> </p> 
		<p style="font-size: 20px;">
         <strong style="color: #FF69B4;">  Tulips:</strong>  
		 Characterized by their variety of colors (from bright red to yellow, pink, white, and other gradient colors)<br>
		 and their cup-shaped flowers, they are considered a symbol of luxury and high beauty.<br>
		 Tulips are associated with spring, and are considered one of the flowers that<br>
		 symbolize love, beauty, and hope, and are usually given as gifts on special occasions <br>
		 such as Valentine's Day or wedding anniversaries.<br><br>
       ...
       <br>
          <strong style="color: #FF69B4;">Tulips and daisies Combination: </strong><br>
       <br>
         Tulips and daisies together are an arrangement that expresses balance and harmony between colors, shapes, and emotions. <br>
		 This combination of flowers embodies natural beauty, eternal love, and purity, <br>
		 making it ideal as a gift that expresses true love and celebrates simple beauty.<br>
</p>
