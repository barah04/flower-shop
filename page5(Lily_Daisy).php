...
<head>
    ...
    <title>Page5(Lily and Daisy)</title>
    <style>
        body {
...
<!-- القائمة الجانبية للمستخدم -->
    ...
    <h1 class="product-title">Lily and Daisy</h1>
    <div class="product-container">
        <img  id="mainProductImage" src="https://cdn.shopify.com/s/files/1/0741/2259/2535/files/charming-white-lilies-bouquet-standard_1_1.webp?v=1704569788" 
        ...
        <div class="product-thumbnails">
            <img src="https://cdn.shopify.com/s/files/1/0741/2259/2535/files/charming-white-lilies-bouquet-standard_1_1.webp?v=1704569788" 
                alt="صورة مصغرة 1" class="thumbnail"
				onclick="changeMainImage('https://cdn.shopify.com/s/files/1/0741/2259/2535/files/charming-white-lilies-bouquet-standard_1_1.webp?v=1704569788')">
            <img src="https://www.tabrahflowers.com/cdn/shop/files/IMG_7605copy.jpg?v=1707763187&width=1445" 
                alt="صورة مصغرة 2" class="thumbnail"
				onclick="changeMainImage('https://www.tabrahflowers.com/cdn/shop/files/IMG_7605copy.jpg?v=1707763187&width=1445')">
            <img src="https://tse1.mm.bing.net/th?id=OIP.GQqfSTG3PW4n20wIpscqEQHaHa&pid=ImgDet&w=158&h=158&c=7" 
                alt="صورة مصغرة 3" class="thumbnail"
				onclick="changeMainImage('https://tse1.mm.bing.net/th?id=OIP.GQqfSTG3PW4n20wIpscqEQHaHa&pid=ImgDet&w=158&h=158&c=7')">
        </div>
        <div class="price">$20.00 JOD</div>
    </div>

    <form action="page5php.php" method="post">
   <input type="hidden" name="bouquet_id" value="3333">
   <input type="hidden" name="Boiqiets_Name" value="Lily and Daisy">
 ...
 <script>
	 ...
	 <p style="font-size: 30px;"> <strong style="color: #FF69B4;"> DESCRIPTION</strong> </p> 
		<p style="font-size: 20px;">
         <strong style="color: #FF69B4;">   Lily:</strong>
       A flower of luxury and beauty, it is a symbol of grace and grandeur.<br>
	   It is characterized by its fragrant scent and its various colors <br>
	   such as white, orange, yellow, pink, and red.<br><br>

In many cultures, lily is considered a symbol of purity, innocence, and pure love,<br>
 and may be associated with spirituality and renewal.<br>
It is also said that white lily represents purity and perfection, while red lily symbolizes deep passionate love.<br>
       <br>
       ...
       <br>
          <strong style="color: #FF69B4;">Lily and Daisy Combination: </strong><br>
       <br>
         Lily with daisy is a floral arrangement that reflects the balance between strength and purity,<br>
		 showing the beauty inherent in combining luxury and simplicity. <br>
		 It symbolizes pure love, renewal, and innocence, and is considered an ideal combination for those looking for a symbol of spiritual beauty and joy in life.
		 </p> 
...
please check back for updates..<br> <br> <?php
session_start(); // بدء الجلسة
$user_name = $_SESSION['first_name'];  // استرجاع اسم المستخدم من الجلسة
?>
<!DOCTYPE html>
...
Orders placed by 1pm can be delivered on the same day (Friday and Saturday).<br>
    ...
    <div class="footer-contact">
	 <p>Thank you for visiting us!</p>
        <button onclick="window.location.href='smslink://'+123456789">SMS</button>
